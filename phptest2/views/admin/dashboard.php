		...
		<table class="table table-responsive">
			...
			<?php foreach($all as $b):?>
				<tr>
					...
					<td><?= $b->website ?></td>
					<td>
						<a href="/views/admin/business.php?id=<?= $b->id ?>" class="btn btn-primary" >More>> </a><br>
						<a href="/views/delete_business.php?id=<?= $b->id ?>" class="btn btn-danger delete-btn">Delete </a>
					</td>
				</tr>
			<?php endforeach; ?>
			</tbody>
